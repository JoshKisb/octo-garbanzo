          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="shadow-md border-houg-secondary/20">
              <CardContent className="p-6">
                ...
                <p className="mb-4">
                  You can also make a direct bank transfer to our Uganda account. Use the following details:
                </p>
                <ul className="text-sm mb-4">
                  <li><strong>Bank Name:</strong> Centenary Rural Development Bank Limited</li>
                  <li><strong>SWIFT Code:</strong> CERBUGKA</li>
                  <li><strong>Beneficiary Name:</strong> Hands On Unemployment Uganda</li>
                  <li><strong>Account Number:</strong> 3204762297</li>
                  <li><strong>Bank Branch:</strong> Centenary Kamuli Branch</li>
                  <li><strong>Intermediary Bank:</strong> Citi Bank N.A, New York</li>
                  <li><strong>Intermediary SWIFT Code:</strong> CITIUS33</li>
                  <li><strong>Intermediary Account Number:</strong> 36022172</li>
                </ul>
                <a href="/contact" className="text-houg-primary font-medium hover:underline">
